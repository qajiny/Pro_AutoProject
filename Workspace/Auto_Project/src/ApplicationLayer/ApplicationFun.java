...
public class ApplicationFun 
{
	  ...
	  static Logger log = Logger.getLogger(ApplicationFun.class.getName());
	  ApplicationFun()
	  {
	  ...
	  {	  
		  ...
		  log.info("Create Account : " + BaseClass.testDataMap.get("emailId"));
	  }
	  ...
	  public static void completeThePurchase() throws InterruptedException
	  {
		  ...
		  log.info("Price of product " + BaseClass.testDataMap.get("Product1")+ " is " + price);
		  double dblPrice = Double.parseDouble(price);
		  dblPrice = dblPrice *2;
		  log.info("Price of product " + BaseClass.testDataMap.get("Product1")+ " for 2 quantity is " + dblPrice);
		  ...
		  log.info("Total of product " + BaseClass.testDataMap.get("Product1")+ " for 2 quantity is " + dblPrice1);
		  ...
		  log.info("Sum of product prices = Total : " + TotalProducts);
		  ...
		  log.info("Sum of product prices + Shipping = Total : " + TotalShipping);
		  ...
		  log.info("Sum of product prices + Shipping + Tax = Total : " + Total2);
		  ...
		  // Commented as not able to proceed
		  // Address page
